...
{
    public static class RepairTab
    {
        //public static (bool isValid, InstallVersionHelper.InstallType type) IsValidRepairPath(string basePath)
        //{
        //    var isValid = false;
        //    var installType = InstallVersionHelper.InstallType.Invalid;
