...
{
    public static class TechToolsTab
    {
        ...
        //        var result = RepairTab.IsValidRepairPath(installDirectory);
        //        if (result.isValid)
        //        {
        ...
        //    private static void StartProcdumpCmd(string installDirectory, InstallVersionHelper.InstallType type, bool altCommand = false)
        //    {
